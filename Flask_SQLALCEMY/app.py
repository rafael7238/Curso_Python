...
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql://root:rafael19@localhost/curso_python"
...
def seleciona_usuarios():
    ...
    print(usuarios_objetos, type(usuarios_objetos))
    return gera_response(200, "usuarios", usuarios_json, "ok")

@app.route('/',methods=["GET"])
def seleciona_usuarios2():
    usuarios_objetos = Usuario.query.all()
    usuarios_json = [usuario.to_json() for usuario in usuarios_objetos]
    print(usuarios_objetos, type(usuarios_objetos))
    return gera_response(200, "usuarios", usuarios_json, "ok")
...
def seleciona_usuario(id):
    ...
    return gera_response(200, "usuario", usuarios_json, "ok")

@app.route("/teste/", methods=["GET"])
def seleciona_usuario2():
    return gera_response(200, "usuario", {"nome":"nada"}, "ok")
